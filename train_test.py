...
def train_intent(train_test=1):
    ...
    pretrained_model_path ='data/pie/intention/27Jan2021-00h15m00s'#'data/pie/intention/context_loc_pretrained'#'data/pie/intention/13Jan2021-20h27m10s'
    ...
    if train_test < 2:  # Train
        ...
        saved_files_path = t.train(data_train=beh_seq_train,
                                   ...
                                   location=False,
                                   context=False, #if you change this you need to regen the images! (219)
                                   lstm=True, #alternative is densenet
                                   data_opts=data_opts)
    ...
    if train_test > 0:  # Test
        ...
        beh_seq_test = imdb.generate_data_trajectory_sequence('test', **data_opts)
        acc, f1 = t.test_chunk(beh_seq_test, data_opts, saved_files_path, 
                               visualize=True, location=False, context=False, lstm=True)
...
def main(dataset='pie', train_test=1):
